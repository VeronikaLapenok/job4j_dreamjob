...
class VacancyControllerTest {
    ...
    @Test
    public void whenGetVacancyByIdThenGetOneVacancy() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var idArgumentCaptor = ArgumentCaptor.forClass(Integer.class);
        when(vacancyService.findById(idArgumentCaptor.capture())).thenReturn(Optional.of(vacancy));
    ...
    @Test
    public void whenGetVacancyByIdThenGetErrorPage() {
        var expectedException = new RuntimeException("Vacancy with the specified ID was not found");
    ...
    @Test
    public void whenUpdateVacancyThenRedirectVacancies() throws Exception {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenUpdateVacancyThenGetErrorPage() {
        var expectedException = new RuntimeException("Vacancy with the specified ID was not found");
    ...
    @Test
    public void whenDeleteVacancyThenRedirectVacancies() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var idArgumentCaptor = ArgumentCaptor.forClass(Integer.class);
    ...
    @Test
    public void whenDeleteVacancyThenGetErrorPage() {
        var expectedException = new RuntimeException("Vacancy with the specified ID was not found");
