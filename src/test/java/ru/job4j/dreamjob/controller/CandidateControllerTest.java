...
class CandidateControllerTest {
    ...
    @Test
    public void whenGetCandidateByIdThenGetOneCandidate() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var idArgumentCaptor = ArgumentCaptor.forClass(Integer.class);
        when(candidateService.findById(idArgumentCaptor.capture()))
    ...
    @Test
    public void whenGetCandidateByIdThenGetErrorPage() {
        var expectedException = new RuntimeException("Resume with the specified ID was not found");
    ...
    @Test
    public void whenUpdateCandidateThenRedirectCandidates() throws Exception {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenUpdateCandidateThenGetErrorPage() {
        var expectedException = new RuntimeException("Resume with the specified ID was not found");
    ...
    @Test
    public void whenDeleteCandidateThenRedirectCandidates() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var idArgumentCaptor = ArgumentCaptor.forClass(Integer.class);
    ...
    @Test
    public void whenDeleteCandidateThenGetErrorPage() {
