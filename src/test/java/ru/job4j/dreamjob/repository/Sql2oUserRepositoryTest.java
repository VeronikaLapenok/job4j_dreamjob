...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var savedUser = sql2oUserRepository.findByEmailAndPassword(email, password).get();
    ...
    public void whenDontSaveThenNothingFound() {
        ...
        assertThat(sql2oUserRepository.findByEmailAndPassword(null, null)).isEqualTo(empty());
    }

    @Test
    public void whenEmailSameThenEmpty() {
        var email = "email";
        var user = sql2oUserRepository.save(new User(0, email, "name", "password1")).get();
        assertThat(sql2oUserRepository.save(new User(0, email, "name2", "password2")).isEmpty());
    }
}
